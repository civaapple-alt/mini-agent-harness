...
variables. Use the App Server capability and world status interfaces to inspect
the loaded runtime and extension summary; this does not connect to MCP servers
until a turn uses them.
