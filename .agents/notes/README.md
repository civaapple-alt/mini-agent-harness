...
- runtime (`core + protocol + host + app-server`): `15,928 / 20,000` lines (79.6%; 4,072 remaining)
- all Rust source: `29,057 / 30,000` lines (96.9%; 943 remaining)
