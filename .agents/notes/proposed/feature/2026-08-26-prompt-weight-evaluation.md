...
Execute the prompt weight evaluation benchmark ([Prompt Weight Protocol](.agents/notes/archived/experiments/2026-08-24-prompt-weight.md)) against real authorized provider models (e.g. DeepSeek V4 / OpenAI models):
