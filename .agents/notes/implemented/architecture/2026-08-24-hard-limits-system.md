...
All model-visible inputs, outputs, tool invocations, and conversation context sizes are bounded by hard limits specified in [`HarnessConfig`](file:///D:/gh-ws/codex-ws/mini-codex/crates/mini-agent-core/src/harness.rs):
