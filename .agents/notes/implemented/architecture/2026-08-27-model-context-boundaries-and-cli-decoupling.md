...
### 6. Opt-in Persistence & Step Limit Semantics
- Interactive sessions default to process-local memory; `--persist` opts in to creating durable session files under `~/.mini-agent/sessions/`.
