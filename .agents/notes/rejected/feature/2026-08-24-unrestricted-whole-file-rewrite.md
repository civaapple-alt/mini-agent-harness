...
1. **Unrelated Code Loss**: Experimental validation ([Edit Surface Comparison](../../archived/experiments/2026-08-24-edit-surface.md)) showed that while whole-file rewrites and precise search-and-replace both reach target changes in three steps, full-file rewrites frequently drop unrelated lines, comments, and imports in larger files.
