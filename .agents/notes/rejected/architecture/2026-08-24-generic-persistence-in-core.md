...
2. **Microkernel Violation**: Adding persistence violates core separation of concerns. Persistence is an edge integration requirement ([`crates/mini-agent-capabilities/src/session.rs`](../../../../crates/mini-agent-capabilities/src/session.rs)).
