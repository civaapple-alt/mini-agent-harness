...
- Subagent `meta.json` / `output.json` now live next to the child session under `~/.mini-agent/sessions/<workspace>/<id>/` instead of polluting the project `.agents/sessions/` directory.
